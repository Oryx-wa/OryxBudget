...
@Component({
  selector: 'app-fileupload-attachment',
  templateUrl: './fileupload-attachment.component.html',
  styleUrls: ['./fileupload-attachment.component.scss']
})
export class FileuploadAttachmentComponent implements OnInit {
